...
export type GetAssetsForAssetsListQuery = {
    __typename?: 'Query';
    assets: {
        ...
        pageInfo: { __typename?: 'PageInfo'; currentPage: number; totalPages: number };
    };
};

export type AssetsItemFragment = {
    __typename?: 'Asset';
    id: any;
    title?: string | null;
    serialNumber: string;
    waybillDate: any;
    tagNumber?: string | null;
    type: { __typename?: 'AssetType'; id: any; title?: string | null; icon?: string | null };
    location?: {
        __typename?: 'Location';
        id: any;
        country: string;
    ...
    assignee?: {
        ...
        lastName?: string | null;
        avatar?: string | null;
        position?: { __typename?: 'EmployeePosition'; id: any; name?: string | null } | null;
    } | null;
};

export type AssetsTypeFragment = {
    __typename?: 'AssetType';
    id: any;
    title?: string | null;
    icon?: string | null;
...
export type AssetsLocationFragment = {
    __typename?: 'Location';
    id: any;
    country: string;
    details?: string | null;
...
export type AssetsAssigneeFragment = {
    __typename?: 'Employee';
    id: any;
    firstName?: string | null;
    lastName?: string | null;
...
export type AssetsAssigneeEmployeeFragment = {
    __typename?: 'EmployeePosition';
    id: any;
    name?: string | null;
};
 ...
 * });
 */
export function useGetAssetsForAssetsListQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetAssetsForAssetsListQuery,
        GetAssetsForAssetsListQueryVariables
    >,
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetAssetsForAssetsListQuery, GetAssetsForAssetsListQueryVariables>(
        GetAssetsForAssetsListDocument,
        options,
    );
}
export function useGetAssetsForAssetsListLazyQuery(
    ...
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<GetAssetsForAssetsListQuery, GetAssetsForAssetsListQueryVariables>(
        GetAssetsForAssetsListDocument,
        options,
    );
}
export type GetAssetsForAssetsListQueryHookResult = ReturnType<
    typeof useGetAssetsForAssetsListQuery
>;
export type GetAssetsForAssetsListLazyQueryHookResult = ReturnType<
    typeof useGetAssetsForAssetsListLazyQuery
>;
export type GetAssetsForAssetsListQueryResult = Apollo.QueryResult<
    GetAssetsForAssetsListQuery,
    GetAssetsForAssetsListQueryVariables
>;
