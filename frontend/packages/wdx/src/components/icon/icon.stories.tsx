...
import WIcon, { WSvgIcon } from './index';
...
const Template: Story = args => {
  return (
    <WStack direction="row" spacing={2} justifyContent="center" alignItems="center" p={3}>
...
const TemplateSVG: Story = (args) => {
    return (
        <WStack alignItems="center" p={3}>
            <WSvgIcon {...args} >
...
export const SvgIcon = TemplateSVG.bind({});
