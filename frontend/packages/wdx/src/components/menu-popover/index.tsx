...
const ArrowStyle = styled('span')<ArrowStyleProps>(({ arrow, theme }: any) => {
  const SIZE = 12;
...
export interface WMenuPopoverProps extends PopoverProps {
  arrow?: Arrow;
  disabledArrow?: boolean;
}

export default function WMenuPopover({
  children,
  arrow = 'top-right',
  disabledArrow,
  sx,
