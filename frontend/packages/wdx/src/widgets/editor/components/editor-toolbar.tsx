...
import WEditorToolbarStyle from './editor-toolbar.styles';
...
type WEditorToolbarProps = {
  id: string;
  isSimple?: boolean;
};

function WEditorToolbar({ id, isSimple, ...other }: WEditorToolbarProps) {
  return (
    <WEditorToolbarStyle {...other}>
      <div id={id}>
        ...
        {!isSimple && (
          <div className="ql-formats">
            <button type="button" className="ql-undo">
              <WIcon name="undo" width={18} height={18} />
            </button>
            <button type="button" className="ql-redo">
              <WIcon name="redo" width={18} height={18} />
            </button>
          </div>
        )}
      </div>
